...
const contact = () => {
    return (
        <div className=" bg-[#070806]">
            ...
            <section className=" max-w-6xl mx-auto px-5 lg:px-0 pt-5 md:pt-10 lg:pt-14 pb-10 md:pb-20 lg:pb-32">
                ...
                <div className="container px-6 md:px-12">
                    <div
                        className="block rounded-lg bg-[#131412] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-700">
                                ...
                                <div className="flex flex-wrap">
                                    <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                                        <div className="flex items-start">
                                            <div className="shrink-0">
                                                <div className="inline-block rounded-md bg-teal-600 p-4 text-white">
                                    ...
                                    <div
                                        ...
                                        <div className="align-start flex">
                                            ...
                                            <div className="ml-6 grow">
                                                <p className="mb-2 font-bold text-gray-200 ">Land Line</p>
                                    ...
                                    <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                                        <div className="align-start flex">
                                            ...
                                            <div className="ml-6 grow">
                                                <p className="mb-2 font-bold text-gray-200 ">Mobile</p>
                                                <p className="text-neutral-300"> +8801892-814892
                                                </p>
                                            </div>
                                        </div>
