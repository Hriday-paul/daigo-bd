...
const HomeSlider = () => {
    ...
    return (
        <div className="h-[350px] md:h-[420px] w-full lg:h-screen relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 min-w-full z-10">
                <div data-aos="fade-left" data-aos-duration="1500" className="h-[calc(350px-116px)] md:h-[calc(420px-136px)] lg:h-[calc(100vh-164px)] flex items-center max-w-6xl mx-auto px-4">
            ...
            <div className="ease-linear duration-500 flex transform-gpu" style={{ transform: `translateX(-${currentSlider * 100}%)` }}>
                ...
                {carouselImages.map((slide, inx) => (
                    <div key={slide} className="relative min-w-full h-[350px] sm:h-96 md:h-[420px] lg:h-[100vh]">
